...
public class Hero {
    ...
    public void restoreFromMemento(HeroMemento memento) {
        if (memento == null) throw new IllegalArgumentException("memento must not be null");
    ...
    public String toString() {
        return String.format("Hero{name='%s', hp=%d/%d, mana=%d, gold=%d, atk=%d, def=%d}",
                name, hp, maxHp, mana, gold, attackPower, defense);
    }
}