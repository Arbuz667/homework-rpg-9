...
public final class HeroMemento {
    ...
    HeroMemento(String name, int hp, int mana, int gold,
                int maxHp, int attackPower, int defense,
        ...
        this.inventorySnapshot = inventorySnapshot == null
                ? List.of() : List.copyOf(inventorySnapshot);
    }

    // package-private — Caretaker (other package) cannot read these
